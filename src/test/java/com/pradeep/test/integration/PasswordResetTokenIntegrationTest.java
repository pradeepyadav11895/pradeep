...
public class PasswordResetTokenIntegrationTest extends AbstractIntegrationTest{
    ...
    public void testFindTokenByTokenValue()throws Exception{
        ...
        PasswordResetToken retrievedPasswordResestToken=passwordResetTokenRepository.findByToken(token);
        Assert.assertNotNull(retrievedPasswordResestToken);
        Assert.assertNotNull(retrievedPasswordResestToken.getId());
        Assert.assertNotNull(retrievedPasswordResestToken.getUser());
